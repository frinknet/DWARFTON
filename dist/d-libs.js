...
o[x]=a[i][x]
return o},N=null
/*LIBS*/const L=function(s,p){var l,a=[].concat.apply
...
return l},S=(U=>{var l=W.localStorage,s=W.sessionStorage,j=JSON,x=(t,k,v)=>{var l=L(t+'#'+k)[0],m=l&&l.innerText,n=O(D.createElement(t),{id:k,innerText:v||m})
